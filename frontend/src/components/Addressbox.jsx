...
const getMapUrl = (address) => {
  const parts = [address.localAddress, address.district, address.province]
    .filter(Boolean)
    .join(", ");
...
const EMPTY_FORM = {
  houseNum: "", localAddress: "", district: "", province: "", phone: "",
};
    ...
    <div className="p-4 rounded-xl bg-lux-light/20 w-84 max-h-72">
        ...
        <form onSubmit={form.onSubmit(handleSubmit)} className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-1">
              <label className="text-lux/60 font-fair text-xs mb-1 block">
                House / Flat No. <span className="text-slate-400 text-xs">*optional</span>
              </label>
              <input
                placeholder="1XX"
          ...
          <div className="flex gap-3 mt-2">
            ...
            <button
              type="submit"
              className="flex-1 bg-lux text-cream font-fair text-sm py-2.5 rounded-lg hover:opacity-90 transition-opacity"
            >
              Save Address
            </button>
          </div>
      ...
      <div>
        ...
        <div className="flex justify-between">
          <p className="capitalize font-fair">
        ...
        <>
          <div className="grid grid-cols-2 gap-4 mt-4">
            ...
            <div>
              ...
              <p className="capitalize font-fair">{address?.localAddress}</p>
            </div>
            <div>
              <p className="text-lux-light font-semibold">District :</p>
              <p className="capitalize font-fair">{address?.district}</p>
            </div>
            <div>
              <p className="text-lux-light font-semibold">Province :</p>
              <p className="capitalize font-fair">{address?.province}</p>
            </div>
          </div>
