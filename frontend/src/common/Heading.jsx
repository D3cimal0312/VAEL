  ...
  return (
    <div {...aosProps} >
      ...
      <div className={lineUp}>
        <h2 className="font-cormorant text-4xl md:text-6xl font-bold ">{mainheading}</h2>
        <h2 className="font-cormorant text-4xl md:text-6xl font-bold italic text-lux">{termheading}</h2>
