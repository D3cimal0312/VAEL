...
const ProductForm = () => {
  ...
  const handleAddTag = () => {
    ...
    if (form.values.tags.length >= 5) {
      form.setFieldError("tagInput", "Maximum 5 tags allowed");
      return;
    }
  ...
  const sectionTitle =
    "text-lg font-medium text-ink border-b border-hair/30 pb-2 mb-4 mt-8";
        ...
        <div className="max-w-5xl mx-auto p-6">
          ...
          <form onSubmit={form.onSubmit(handleSubmit)} className="space-y-4">
            ...
            <div>
              ...
              />
              {form.errors.price && (
                <p className={errorClass}>{form.errors.price}</p>
              )}
            </div>
            ...
            {form.values.isSale && (
              <div>
                ...
                {form.errors.originalPrice && (
                  <p className={errorClass}>{form.errors.originalPrice}</p>
                )}
              </div>
            )}
            ...
            <div>
              ...
              />
              {form.errors.stock && (
                <p className={errorClass}>{form.errors.stock}</p>
              )}
            </div>
            ...
            <div>
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  onChange={(e) =>
                    form.setFieldValue("tagInput", e.target.value)
                  }
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      e.preventDefault();
                  ...
                  placeholder="Type a tag and press Enter~limit:5 tags"
                  className={inputClass}
                ...
                <button
                  ...
                  className="px-4 py-2 bg-lux text-white rounded-md text-sm hover:bg-lux/90 transition-colors whitespace-nowrap"
                >
                  Add Tag
                </button>
              </div>
              <div className="flex flex-wrap gap-2">
                {form.values.tags.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-white border border-hair text-xs text-ink"
                  >
                    {tag}
                    <button
                      type="button"
                      ...
                      className="text-hair hover:text-red-500 ml-1"
                    >
                      ×
                    </button>
                  </span>
            ...
            <div>
              <div className="flex gap-2 mb-3">
                <input
                  ...
                  onChange={(e) =>
                    form.setFieldValue("colorInput", {
                      ...form.values.colorInput,
                      name: e.target.value,
                    })
                  }
                />
                ...
                <button
                  ...
                  className="px-4 py-2 bg-lux text-white rounded-md text-sm hover:bg-lux/90 transition-colors"
                >
                  Add
                </button>
              </div>
              {form.errors.colorInput && (
                <p className={errorClass}>{form.errors.colorInput}</p>
              )}
              <div className="flex flex-wrap gap-2">
                {form.values.colors.map((c, idx) => (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cream-light border border-hair text-xs text-ink"
                  >
                    <span
                      className="w-3 h-3 rounded-full border border-hair/30"
                    ...
                    <button
                      ...
                      onClick={() =>
                        form.setFieldValue(
                          "colors",
                          form.values.colors.filter((_, i) => i !== idx),
                        )
                      }
                      className="text-hair hover:text-red-500"
                    >
                      ×
                    </button>
                  </span>
            ...
            <div>
              <div className="flex gap-2 mb-3">
                <input
                  ...
                  onChange={(e) =>
                    form.setFieldValue("sizeInput", e.target.value)
                  }
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
                      e.preventDefault();
              ...
              <p className="text-xs text-hair mb-2">
                Click a size to mark it as sold out · × to remove
              </p>
              <div className="flex flex-wrap gap-2">
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        form.setFieldValue(
                          "sizes",
                          form.values.sizes.filter((_, idx) => idx !== i),
                        );
                      }}
            ...
            <div>
              ...
              />
              {form.errors.images && (
                <p className={errorClass}>{form.errors.images}</p>
              )}
              {form.values.images.length > 0 && (
                <p className="mt-2 text-sm text-hair">
                  {form.values.images.length} file(s) selected
                </p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {form.errors.rating && (
                <p className={errorClass}>{form.errors.rating}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {form.errors.reviewCount && (
                <p className={errorClass}>{form.errors.reviewCount}</p>
              )}
            </div>
