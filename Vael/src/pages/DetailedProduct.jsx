...
reset();
  ...
  return (
    <div
      className="pl-12 xl:pl-0 xl:pr-14 pb-12  flex gap-24 font-fair flex-wrap xl:flex-nowrap
    "
    >
      <div id="imageSection" className="xl:sticky top-0  flex gap-4 h-fit items-center w-full xl:w-200">
        <div className="md:absolute z-50 flex justify-center ml-4  flex-col gap-4  h-full ">
...
<p className="mb-5 -ml-6 text-green-600 text-3xl font-sans">
        ...
        <div>
          <p className="mb-2 tracking-wider font-serif">Sizes:</p>
    ...
    >
      {size}
        ...
        <div className="flex gap-4 items-center">
          <p className=" tracking-wider font-serif">QTY</p>
          <div className="flex gap ">
            <div
              onClick={() => {
                quantity > 1 ? setQuantity(quantity - 1) : "";
              }}
              className="bg-black  active:bg-lux  text-white font-bold   text-4xl h-10 w-10  flex justify-center items-center"
            >
              <Minus />
            </div>

            <div className="w-10 flex justify-center items-center text-2xl border-t border-b border-lux">
              {quantity}
            </div>
            <div
              onClick={() => {
...
<div className="mt-6">
  <Heading subheading={"YOU MAY ALSO LIKE"} motion={false}/>

<div className="">
    <Card products={similarProducts} limit={6} cols={3}/>
</div>
</div>
      </div>
    </div>
